...
public class EduphoriaCfgGui extends JFrame
{
	...
	private JTextArea txtrHostIpAddress;
	private JTextArea txtrDatabaseName;
	...
	public static void main(String[] args)
	{
		...
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					EduphoriaCfgGui frame = new EduphoriaCfgGui();
	 ...
	 * Create the frame.
	 */
	public EduphoriaCfgGui()
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(EduphoriaCfgGui.class.getResource("/windowBuilder/resources/R10TEDSAI.png")));
	...
	//	mntmExit.setIcon(new ImageIcon(FirstWbGui.class.getResource("/windowBuilder/resources/exit_16.png")));
		...
		pnlCfg.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Eduphoria Configuration Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			...
			gl_pnlCfg.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlCfg.createSequentialGroup()
					.addGroup(gl_pnlCfg.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnlCfg.createParallelGroup(Alignment.TRAILING, false)
							.addComponent(txtrCountyDistrictNumber, Alignment.LEADING)
							.addComponent(textField, Alignment.LEADING))
						.addComponent(textField_1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(txtrCollectionYear, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
		...
		gl_pnlCfg.setVerticalGroup(
			gl_pnlCfg.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlCfg.createSequentialGroup()
					...
					.addGap(27)
					.addComponent(txtrCollectionYear, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
		...
		pnlBenchMarks.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Eduphoria Database Settings", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		rdbtnNewRadioButton = new JRadioButton("Cloud");
		rdbtnNewRadioButton.setFont(new Font("Tahoma", Font.PLAIN, 14));
		rdbtnNewRadioButton.setBackground(Color.WHITE);
		
		rdbtnNewRadioButton_1 = new JRadioButton("On Premise");
		rdbtnNewRadioButton_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		rdbtnNewRadioButton_1.setBackground(Color.WHITE);
		
		txtrHostIpAddress = new JTextArea();
		txtrHostIpAddress.setFont(new Font("Tahoma", Font.PLAIN, 14));
		txtrHostIpAddress.setText("Host IP Address");
		
		txtrDatabaseName = new JTextArea();
		txtrDatabaseName.setFont(new Font("Tahoma", Font.PLAIN, 14));
		txtrDatabaseName.setText("Database Name");
		
		txtrUsername = new JTextArea();
		txtrUsername.setFont(new Font("Tahoma", Font.PLAIN, 14));
		txtrUsername.setText("Username");
		
		txtrPassword = new JTextArea();
		txtrPassword.setFont(new Font("Tahoma", Font.PLAIN, 14));
		txtrPassword.setText("Password");
		
		JTextArea textArea = new JTextArea();
		textArea.setText("Port Number");
			...
			gl_pnlBenchMarks.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnlBenchMarks.createSequentialGroup()
					.addGroup(gl_pnlBenchMarks.createParallelGroup(Alignment.LEADING)
						.addComponent(txtrHostIpAddress, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(txtrDatabaseName, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_pnlBenchMarks.createParallelGroup(Alignment.TRAILING, false)
							.addComponent(textField_2, Alignment.LEADING)
							.addComponent(textField_3, Alignment.LEADING)
							.addComponent(textField_4, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE))
						.addComponent(textArea, GroupLayout.PREFERRED_SIZE, 83, GroupLayout.PREFERRED_SIZE))
					.addGap(94)
					.addGroup(gl_pnlBenchMarks.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(textField_5, 118, 118, Short.MAX_VALUE)
						.addComponent(textField_6, GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
		...
		lblNewLabel.setIcon(new ImageIcon(EduphoriaCfgGui.class.getResource("/windowBuilder/resources/R10Logo.PNG")));
			...
			gl_ctpMain.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_ctpMain.createSequentialGroup()
					.addGroup(gl_ctpMain.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_ctpMain.createSequentialGroup()
							.addComponent(pnlCfg, GroupLayout.DEFAULT_SIZE, 377, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
			...
			gl_ctpMain.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_ctpMain.createSequentialGroup()
					...
					.addGroup(gl_ctpMain.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(pnlBenchMarks, GroupLayout.PREFERRED_SIZE, 268, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
