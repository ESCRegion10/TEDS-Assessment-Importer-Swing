...
public class AssessmentRunGui extends JFrame
{
	...
	public static void main(String[] args)
	{
		...
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				try
				{
					AssessmentRunGui frame = new AssessmentRunGui();
	 ...
	 * Create the frame.
	 */
	public AssessmentRunGui()
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(AssessmentRunGui.class.getResource("/windowBuilder/resources/R10TEDSAI.png")));
	...
	//	mntmExit.setIcon(new ImageIcon(FirstWbGui.class.getResource("/windowBuilder/resources/exit_16.png")));
		...
		pnlCfg.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "College Assessment Test Information", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		
		txtrCountyDistrictNumber = new JTextArea();
		txtrCountyDistrictNumber.setText("Input File");
		...
		txtrCollectionYear.setText("Student-Parent XML File");
		...
		lblNewLabel.setIcon(new ImageIcon(AssessmentRunGui.class.getResource("/windowBuilder/resources/R10Logo.PNG")));
		...
		pnlBenchMarks.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Choose College Assessment Test to Execute", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
